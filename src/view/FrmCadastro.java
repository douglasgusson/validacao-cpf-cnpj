...
public class FrmCadastro extends javax.swing.JFrame {
    ...
    private void initListeners() {
        ...
        btOk.addActionListener((ActionEvent e) -> {
            // remove a máscara caso ela tenha sido aplicada
            String s = tfCpfCnpj.getText()
                    .replaceAll("\\.", "")
                    .replace("-", "")
                    .replace("/", "");
            // no caso de 11 digitos verifica CPF e aplica máscara
            if (s.length() == 11) {
                tfCpfCnpj.setText(Valida.imprimeCPF(s));
            // no caso de 14 digitos verifica CPF e aplica máscara   
            } else if (s.length() == 14) {
                tfCpfCnpj.setText(Valida.imprimeCNPJ(s));
            // senão o documento não é válido
            } else {
        ...
        // para o campo aceitar apenas números
        tfCpfCnpj.addKeyListener(new KeyAdapter() {
            @Override
        ...
        // remove a máscara quando o foco entra no campo
        tfCpfCnpj.addFocusListener(new FocusAdapter() {
            @Override
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tfCpfCnpj, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(154, 154, 154)
                        .addComponent(btOk)))
